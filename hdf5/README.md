...
1. Install AFS client on your local machine, and connect to `golem:/afs/psi.ch/project/esther`
Installing and configuring tecnico [OpenAFS](https://si.tecnico.ulisboa.pt/en/servicos/armazenamento-e-backup/armazenamento-afs/instalacao-e-configuracao-do-openafs-em-linux-e-mac-os/) in Linux and Mac OS.
